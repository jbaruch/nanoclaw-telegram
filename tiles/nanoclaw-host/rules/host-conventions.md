...
AyeAye edits asynchronously — you don't know what changed or when. Before declaring any staging content "already promoted" or "stale", always diff it against the current tile version. A file with the same name may have completely different content.
